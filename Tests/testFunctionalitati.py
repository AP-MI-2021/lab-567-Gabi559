...
from Logic.functionalitate import discount, modificareGen, commandConsole, pretMinim, ordonareDupaPret, nrTitluriPeGen
...
def testModificareGen():
    ...
    lista = adaugaLibrarie("1", "Baltagul", "Traditionalism", 15, "none", lista)
    lista = adaugaLibrarie("2", "Ion", "Realism", 20, "silver", lista)
    lista = adaugaLibrarie("3", "Enigma Otiliei", "Interbelic", 25, "gold", lista)
